...
\hlstd{+ }     \hlkwc{xlab}\hlstd{=}\hlstr{"Mother's height (inch)"}\hlstd{,}\hlkwc{ylab}\hlstd{=}\hlstr{"Birth weight (oz)"}\hlstd{)}
...
\hlstd{+ }          \hlkwc{xlab}\hlstd{=}\hlstr{"Mother's weight (lb)"}\hlstd{,}\hlkwc{ylab}\hlstd{=}\hlstr{"Birth weight (oz)"}\hlstd{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(bwt} \hlopt{~} \hlstd{gestation,}\hlkwc{data} \hlstd{= Babies.df,}\hlkwc{ylab}\hlstd{=}\hlstr{"Birth weight (oz)"}\hlstd{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(bwt} \hlopt{~} \hlstd{age,}\hlkwc{data} \hlstd{= Babies.df,}\hlkwc{xlab}\hlstd{=}\hlstr{"Mother's age"}\hlstd{,}\hlkwc{ylab}\hlstd{=}\hlstr{"Birth weight (oz)"}\hlstd{)}
